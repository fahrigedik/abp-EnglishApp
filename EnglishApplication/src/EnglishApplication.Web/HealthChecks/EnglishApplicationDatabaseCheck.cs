...
public class EnglishApplicationDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public EnglishApplicationDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
