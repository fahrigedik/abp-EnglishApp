...
namespace EnglishApplication.Migrations
{
    ...
    partial class EnglishApplicationDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnglishApplication.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("EnglishApplication.WordDetails.WordDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EnglishApplication.WordSamples.WordSample", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EnglishApplication.Words.Word", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EnglishWordName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TurkishWordName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EnglishApplication.QuizAttempts.QuizAttempt", b =>
                {
                    ...
                    b.HasOne("EnglishApplication.Words.Word", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EnglishApplication.UserSettings.UserSetting", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("EnglishApplication.UserSettings.UserSetting", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("EnglishApplication.WordDetails.WordDetail", b =>
                {
                    b.HasOne("EnglishApplication.Words.Word", null)
                        .WithOne()
                        .HasForeignKey("EnglishApplication.WordDetails.WordDetail", "WordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
